                  ...
                  //&& 若左邊order有值,才會渲染右邊()的資料
                   ...
                   <div className="totalSection w-full h-[127px] flex flex-col items-center justify-between">
                     <div className="flex items-center w-full mt-10 tracking-[0.2em]">
                       <div className="flex items-center w-full flex-1 mx-10">
                         ...
                         <div className="flex flex-col">
                           <span className="w-full">客戶姓名：{order[0].username}</span>
                       ...
                       <div className="flex items-center w-full flex-1 mx-10 ">
                         ...
                         <div className="flex flex-col">
                           <span className="w-full">運送方式：{order[0].shipping_method}</span>
                           <span className=" ">付款方式：{order[0].payment_method}</span>
                         </div>
                       </div>
                       <div className="flex items-center w-full flex-1 ">
                         <IoMdPin className="fill-[#F58A9E] mr-5 w-[40px] h-[40px]" />
                         <div className="flex flex-col">
                           <span className="w-full">運送地址: {order[0].postal_code}</span>
                           <span className="">{order[0].city}{order[0].address_line}</span>
                         </div>
                       </div>
                     </div>
                               ...
                               <td className="border-none tracking-[0.3em] ">
                                 <div className="flex items-center  mx-5">
                                   ...
                                   <div className="flex flex-col  justify-start  ml-5 text-left">
                                     <span className="w-full">{order[0].product_SKU}</span>
                                     <span>{order[0].product_name}</span>
                                   </div>
                                 </div>
                               </td>
   
                               <td className="border-none">{order[0].product_price}</td>
                               <td className="border-none">{order[0].qty}</td>
                               <td className="border-none">NT ${order[0].subtotal}</td>
                             ...
                             <tr>
                               <td className="border-none tracking-[0.3em]">
                                 <div className="flex items-center w-full flex-1 mx-5">
                                   ...
                                   />
                                   <div className="flex flex-col justify-start   ml-5 text-left">
                                     <span className="w-full">{order[1].product_SKU}</span>
                                     <span>{order[1].product_name}</span>
                                   </div>
                                 </div>
                               </td>
                               <td className="border-none">{order[1].product_price}</td>
                               <td className="border-none">{order[1].qty}</td>
                               <td className="border-none">NT ${order[1].subtotal}</td>
                               <td className="border-none">&#10003;</td>
                             </tr>
                             <tr>
                               <td className="border-none tracking-[0.3em] ">
                                 <div className="flex items-center w-full flex-1 mx-5">
                                   ...
                                   <div className="flex flex-col justify-center  ml-5 text-left ">
                                     <span className="w-full">{order[2].product_SKU}</span>
                                     <span>{order[2].product_name}</span>
                                   </div>
                                 </div>
                               </td>
                               <td className="border-none">{order[2].product_price}</td>
                               <td className="border-none">{order[2].qty}</td>
                               <td className="border-none">NT ${order[2].subtotal}</td>
                             </tr>
                           </tbody>
                         </table>
                       </div>
                     ...
                     <div className="total flex w-[1108px]  justify-end tracking-[0.3em] gap-10 mt-3">
                       <span>商品金額：{order[0].subtotal + order[1].subtotal + order[2].subtotal}</span>
